                ...
                <v-card-text>
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="12" sm="6" md="6">
                                <v-text-field label="Anzahlung*" required v-model="rowData.upfront">
                                </v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="6">
                                <v-text-field label="Rate*" required v-model="rowData.rate"></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="6">
                                <v-text-field label="TCO*" required v-model="rowData.tco"></v-text-field>
                            </v-col>
                        </v-row>
                        <v-row>
